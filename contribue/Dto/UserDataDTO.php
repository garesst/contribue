...
class UserDataDTO {
    ...
    public function __construct($postData) {
        $this->name_user = isset($postData['name_user']) ?  strtoupper($postData['name_user']) : null;
        $this->lastname_user = isset($postData['lastname_user']) ? strtoupper($postData['lastname_user']) : null;
        $this->email_user = isset($postData['email_user']) ? strtolower($postData['email_user']) : null;
        ...
        $this->workspace_user = isset($postData['workspace_user']) ? strtolower($postData['workspace_user']) : null;
    }
    ...
    public function isValid() {
        ...
        if (empty($this->workspace_user)) {
            $errors['workspace_user'] = 'El workspace es requerido';
        }
